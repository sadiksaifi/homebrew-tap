class Mdp < Formula
  ...
  homepage "https://github.com/sadiksaifi/mdopen"
  version "0.1.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sadiksaifi/mdopen/releases/download/v0.1.0/mdp-darwin-arm64.tar.gz"
      sha256 "cc65e27b57e81778f9d379586870dc6b7f1b63121cbfa29c651c0a738bdc0786"
    else
      url "https://github.com/sadiksaifi/mdopen/releases/download/v0.1.0/mdp-darwin-amd64.tar.gz"
